//! Test execution and trace logging.
...
pub fn run_tests_and_log(package_path: &Path) -> Result<(), Box<dyn std::error::Error>> {
...
fn log_trace_for_test(
    ...
    if !state_changes.is_empty() {
        ...
        let mut by_fn: std::collections::HashMap<String, Vec<String>> =
